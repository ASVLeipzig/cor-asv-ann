...
# (or just `gnuplot thisfile -` if you want to stay interactive)

# datafile = ARG1[1:strlen(ARG0)-7]."csv" # remove .gnuplot from argument, add .csv
...
set xrange [] writeback # store (does not work)
...
unset xtics
#set xrange [1:154883] # take all individual sequences (not batch epochs)
